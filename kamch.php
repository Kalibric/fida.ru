         ...
         <div class="row">
            <div class="col-md-6">
               <div class="about_taital_main">
                  <h1 class="about_taital">Камчатка</h1>
                  <p class="about_text">На Камчатке чувствуешь себя как на другой планете... <br>
                     Нет, как на планете, где нет людей. Природа, нетронутая человеком, первозданные панорамы. 
                     За 10 дней мы поднимемся на действующие вулканы, искупаемся в горячих источниках, 
                     сплавимся по горной реке.<br> Камчатка: вода и пламя - это возможность отключиться от цивилизации и 
                     прочувствовать на себе мощь и красоту Природы!<br>
                     При проживании в Паратунке купание в термальных бассейнах доступно ежедневно без дополнительной оплаты.
                     <br><br>
                     <ul>Включено:
                    ...
                    <div class="btn_main">
                      ...
                      {
                        ?>
                        <a href="order.php?ID=5">Заказать</a>
                        <?php
                      }
                      else
                      {
            ...
            <div class="col-md-6 padding_right_0">
               <div><img style="height: 650px; width: 700px;" src="images/kamch.png" class="about_img"></div>
            </div>
         </div>
      </div>
   </div>
