         ...
         <div class="row">
            <div class="col-md-6">
               <div class="about_taital_main">
                  <h1 class="about_taital">Алтай</h1>
                  <p class="about_text">Этот маршрут уникален тем, что всего за восемь дней позволит увидеть Алтай во всей своей красе.
                     В программу включены самые известные, интересные и наиболее доступные места.<br><br>
                     Ущелье Актру приковывает внимание белизной ледовых полей. Необычные пейзажи долины Кызыл-Чин позволят побывать на другой планете, так называемой «Алтайский Марс». Самая удивительная и необычная долина реки Чулышман покоряет своим великолепием.
                     Особую атмосферу придаст выступление сказителя-кайчи – мастера горлового пения. И конечно Телецкое озеро – жемчужина Алтая.
                     <br><br>
                     <ul>Включено:
            ...
            <div class="col-md-6 padding_right_0">
               <div><img style="height: 650px; width: 700px;" src="images/altai.jpg" class="about_img"></div>
            </div>
         </div>
      </div>
   </div>
