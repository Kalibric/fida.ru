         ...
         <div class="row">
            <div class="col-md-6">
               <div class="about_taital_main">
                  <h1 class="about_taital">К подножию Белухи</h1>
                  <p class="about_text">Теперь Шамбала твоя. Садись на коня, мы идём к подножию Белухи!<br>
                     Увидеть наивысшую точку Алтайских гор, венчающую Катунский хребет, непросто.<br>
                     Легендарная алтайская святыня - гора Белуха, 
                     открывается лишь тем, кто пройдет по альпийским лугам через брод горных рек, суровую 
                     тайгу и восхитительные горные перевалы. Кристальные водопады, жгуче-холодные реки, берущие свое начало с 
                     вечных ледников. Душевные песни у костра и такие близкие звезды.<br> Здесь, по пути в таинственную Шамбалу, 
                     на самом верху Алтайских гор, до звезд можно дотронуться рукой. Ты боишься подумать об этом? Мы водим группы каждый год! 
                     В этот раз, кажется, ты хочешь с нами?
                     <br><br>
                     <ul>Включено:
                    ...
                    <div class="btn_main">
                      ...
                      {
                        ?>
                        <a href="order.php?ID=3">Заказать</a>
                        <?php
                      }
                      else
                      {
            ...
            <div class="col-md-6 padding_right_0">
               <div><img style="height: 650px; width: 700px;" src="images/beluxa.png" class="about_img"></div>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="footer_section layout_padding">
      <div class="container">
         ...
         <div class="location_main">
            ...
            <div class="call_text"><a href="#">mountains@gmail.com</a></div>
         </div>
