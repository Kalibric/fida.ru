         ...
         <div class="row">
            <div class="col-md-6">
               <div class="about_taital_main">
                  <h1 class="about_taital">Великий Байкал</h1>
                  <p class="about_text">Приглашаем Вас в настоящую зимнюю сказку, добро пожаловать на зимний Байкал!<br>
                     Покрытый льдом Байкал называют самым большим катком в мире. <br>
                     Исторический центр озера - остров Ольхон – сосредоточие древних легенд и исторических преданий. 
                     Он даже по форме напоминает Байкал. А зимой пейзажи преображаются до неузнаваемости. 
                     Легендарный голубой лед, снежные гроты и пещеры и невероятного размера сосульки, от которых ваши дети придут в полный восторг! 
                     <br><br>
                     <ul>Включено:
                    ...
                    <div class="btn_main">
                      ...
                      {
                        ?>
                        <a href="order.php?ID=6">Заказать</a>
                        <?php
                      }
                      else
                      {
            ...
            <div class="col-md-6 padding_right_0">
               <div><img style="height: 650px; width: 700px;" src="images/baykal.jpg" class="about_img"></div>
            </div>
         </div>
      </div>
   </div>
